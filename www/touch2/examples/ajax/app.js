 ...
 * a AJAX request using Ext.Ajax.request or a JSONP request using Ext.util.JSONP.
 */
...
Ext.application({
    ...
    /**
     * This method makes a JSONP request using Ext.util.JSONP. JSONP is used when you need to make cross-domain
    ...
    makeJSONPRequest: function() {
        ...
        //next we use Ext.util.JSONP to make a request
